    ...
    <>
      ...
      <aside className={`sidebar ${isOpen ? 'sidebar-open' : ''}`}>
        ...
        <nav className="sidebar-nav">
          ...
          {NAV_ITEMS.map((item) => {
            // Auth-required items shown only when authenticated
        ...
        {isAuthenticated && user ? (
          ...
          <button className="sidebar-login-cta" onClick={handleLogin}>
